...
<body class="bg-gray-100 text-gray-900 h-full flex flex-col">

  <div class="flex flex-1 h-full">

    <!-- Sidebar -->
    <div class="flex flex-col w-60 bg-white text-gray-900 shadow-lg h-full z-30">
      <!-- Logo and title -->
      ...
      <nav class="flex flex-col mt-6">
        ...
        <a href="#" class="sidebar-link flex items-center px-6 py-4 hover:bg-red-600 hover:text-white transition-colors duration-200">
          ...
          <span class="ml-4 font-normal">Manage Vendor</span>
        </a>   
        <a href="#" class="sidebar-link flex items-center px-6 py-4 hover:bg-red-600 hover:text-white transition-colors duration-200">
        ...
        <a href="#" class="sidebar-link flex items-center px-6 py-4 hover:bg-red-600 hover:text-white transition-colors duration-200">
          ...
          <span class="ml-4 font-normal">Banners</span>
        </a> 
